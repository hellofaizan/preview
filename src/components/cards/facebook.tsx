      ...
      <div className="w-full bg-white rounded-lg shadow">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <div className="flex items-center">
                  <h2 className="font-semibold text-lg">Fayaz Ahmed</h2>
                </div>
        ...
        <div className="border-t">
          <div className="">
            ...
            />
            <div className="p-2 px-3 bg-gray-200">
        ...
        <div className="p-4 border-t flex items-center gap-3">
          ...
          />
          <div className="flex-1 rounded-full border px-4 py-2 bg-gray-200 ">
            <p className="text-gray-500 text-md">Comment as Fayaz Ahmed</p>
          </div>
        </div>
      </div>
    </div>
