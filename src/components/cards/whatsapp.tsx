    ...
    <div className="flex flex-col gap-2 w-full">
      ...
      <div className="w-full">
        ...
        <div className="flex justify-end">
          <div className="bg-[#c6fabd] rounded-t-lg rounded-bl-lg rounded-br-md shadow-sm max-w-[55%] relative">
            {/* Link preview card */}
            <div className="p-[3px] overflow-hidden">
              {/* Image container */}
              <img src={data.image} className="rounded-t-lg" alt="" />
              <div className="bg-[#bbf5af]/85 h-max w-full overflow-hidden rounded-b-lg p-2 py-2">
                <h1 className="font-semibold font-sans">{data.title}</h1>
                <p className="text-xs truncate">{data.description}</p>
              </div>
            </div>

            <div className="p-[2px] px-3 pb-2 flex justify-between items-center">
              <p className="text-sm underline text-green-700 font-semibold font-sans">
                {data.url}
              </p>
